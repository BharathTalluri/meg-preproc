...
cd(['/mnt/homes/home024/btalluri/confirmation_spatial/data/meg/analysis/data_clean/' ID(1:7)])
...
%     end
    ...
    mat_name = ['/mnt/homes/home024/btalluri/confirmation_spatial/data/meg/analysis/comp_ICA/' ID(1:7) '/Matrices'];
    ...
    plot_ICAcomps(ID, artifact_type{n})
